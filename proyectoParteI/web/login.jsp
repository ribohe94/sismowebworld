            ...
            <div id="contents">
                ...
                <section id="login">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><input id="btnInput" name="bntInput" type="submit" value="Ingresar" form="formularioLogin">
                                <input id="pais_ingreso" name="pais_ingreso" type="hidden" form="formularioLogin"></td>
                        </tr>
                    </table>
                    <script>
                        jQuery.ajax({
                            ...
                            success: function (location) {
                                document.getElementById("pais_ingreso").setAttribute("value", location.country_name);
                            }
                        });
                    </script>
                </section>
