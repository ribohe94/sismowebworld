...
//        try {
//            if (datos.verificarLogin(pass, user)) {
//
//                System.out.println("Correcto");
//                //HTTP SESSION
//                HttpSession sesion = request.getSession(true);
//                sesion.setAttribute("usuario", user);
//                if (datos.isAdmin(user)) {
//                    sesion.setAttribute("admin", true);
//                }
//                sesion.setAttribute("valid", true);
//                sesion.setMaxInactiveInterval(60 * 5);
//                request.getRequestDispatcher("login_exito.jsp").forward(request, response);
//                response.sendRedirect("login_exito.jsp");
//            } else {
